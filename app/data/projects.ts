...
const projectDetailsData: ProjectDetailsDataType[] = [
    {
        ...
        featureImage: '/images/studio-manager-screenshots.svg',
        icons: [
    ...
    },
    {
        ...
        featureImage: '/images/studio-manager-mobile-screenshots.svg',
        icons: [
            "/images/icons/vue-js-icon.svg",
    ...
    },
    {
        ...
        featureImage: '/images/tadvantage-screenshots.svg',
        icons: [
            "/images/icons/vue-js-icon.svg",
            "/images/icons/javascript-icon.svg",
