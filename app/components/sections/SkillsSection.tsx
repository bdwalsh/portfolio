        ...
        <div className="w-full lg:max-w-[75rem]">
            ...
            <div className="relative flex flex-wrap justify-center w-full lg:h-auto xl:h-[1000px]">
                {skillsData.map((skill, index) => (
                    <div 
                        key={index}
                        className={`lg:initial xl:absolute flex items-center justify-center bg-accent overflow-hidden mb-8 rounded-full text-black shadow-accent ${skill.animation || ''} ${skill.width || ''} ${skill.height || ''}`}                  
